...
//		{
//			for (int i = 0; i < questList.Count; i++) //first item in quest list
//			{
//				for (int j = 0; j < NPCQuestObject.availableQuestIDs.Count; j++) //goes through complete avaiable list
//				{
